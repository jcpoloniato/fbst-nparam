...
#1 pop com dist normal(0,1) e outra de mistura de 2 normais
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm2n0_tam50-50')
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm2n0_tam100-100')
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm2n0_tam500-500')


## 1 pop de N(0,1) e outra de mistura de 3 normais
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm3n0_tam50-50')
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm3n0_tam100-100')
...
dat<-data.frame(medias=c(medias[,2],medias[,2]),
                poder=c(poder[,1], poder[,2]) ,
                teste=c(rep('ev', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2popmistnorm3n0_tam500-500')


###Duas pop de mistura de normais
mist_norm <- function (n, medias, variancias, probs){
  k <- length(probs)
  vetor<-rep(NA,n)
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2poptrigounif_tam50-50')
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2poptrigounif_tam100-100')
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2poptrigounif_tam500-500')

############################
# UNIFORME DE HAAR vs UNIF##
############################
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2pophaarunif_tam50-50')
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2pophaarunif_tam100-100')
...
dat<-data.frame(medias=rep(1:30,5),
                ...
                teste=c(rep('x2', length(medias)), rep('x5', length(medias)), rep('2x', length(medias)), 
                        rep('5x', length(medias)), rep('pv.ks', length(medias))))
saveRDS(dat, file='2pophaarunif_tam500-500')